    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li
                    class="nav-item has-treeview {{ request()->is('admin/incoming*') ? 'menu-open' : '' }} {{ request()->is('admin/outgoing*') ? 'menu-open' : '' }} {{ request()->is('admin/filter*') ? 'menu-open' : '' }} ">
                    <a class="nav-link nav-dropdown-toggle" href="#">
                        <i class=" nav-icon fas fa-solid fa-envelope">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.incoming.index') }}"
                                class="nav-link {{ request()->is('admin/incoming') || request()->is('admin/incoming/*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.outgoing.index') }}"
                                class="nav-link {{ request()->is('admin/outgoing') || request()->is('admin/outgoing/*') ? 'active' : '' }}">
                                <i class="fa-fw nav-icon fas fa-envelope">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.address.index') }}"
                                class="nav-link {{ request()->is('admin/address') || request()->is('admin/address/*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.filter.index') }}"
                                class="nav-link {{ request()->is('admin/filter') || request()->is('admin/filter/*') ? 'active' : '' }}">
                ...
                @can('user_management_access')
                    <li
                        class="nav-item has-treeview {{ request()->is('admin/permissions*') ? 'menu-open' : '' }} {{ request()->is('admin/roles*') ? 'menu-open' : '' }} {{ request()->is('admin/users*') ? 'menu-open' : '' }} {{ request()->is('admin/fortnoxes*') ? 'menu-open' : '' }} {{ request()->is('admin/integrations*') ? 'menu-open' : '' }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('fortnox_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.fortnoxes.index') }}"
                                        class="nav-link {{ request()->is('admin/fortnoxes') || request()->is('admin/fortnoxes/*') ? 'active' : '' }}">
                            ...
                            @can('integration_access')
                                <li class="nav-item">
                                    <a href="{{ route('admin.integrations.index') }}"
                                        class="nav-link {{ request()->is('admin/integrations') || request()->is('admin/integrations/*') ? 'active' : '' }}">
                ...
                @can('platform_access')
                    <li class="nav-item">
                        <a href="{{ route('admin.platforms.index') }}"
                            class="nav-link {{ request()->is('admin/platforms') || request()->is('admin/platforms/*') ? 'active' : '' }}">
